...
class Response extends Message implements ResponseInterface
{
     ...
     * header json
     */
    const HEADER_CONTENTTYPE_JSON = 'application/json; charset=UTF-8';
    ...
    public function __construct(
        ...
        array $headers = [],
        $streamType = Stream::STREAM_MEMORY,
        $streamMode = 'wb+'
    ) {
        parent::__construct(new Stream($streamType, $streamMode));
     ...
     * @return $this
     */
    public function withMaxAge($value): Response
    {
     ...
     * @return $this
     */
    public function withSharedMaxAge($value): Response
    {
    ...
    {
        $this->withStatus(Response::HTTP_NOT_MODIFIED);
        $this->getBody()->write('');
    ...
    {
        return Response::HTTP_FORBIDDEN === $this->statusCode;
    }
    ...
    {
        return Response::HTTP_NOT_FOUND === $this->statusCode;
    }
    ...
    {
        return ('' == $this->getContents()) ? [] : json_decode($this->getContents(), true);
    }
